...
@Entity
@Table(name="wx_user")//指定表名，若不指定，会默认类名为表名
public class User {
	 ...
	 * 名片分享，ADD_SCENE_QR_CODE 扫描二维码，ADD_SCENEPROFILE LINK 图文页内名称点击，
	 * ADD_SCENE_PROFILE_ITEM 图文页右上角菜单，ADD_SCENE_PAID 
	...
	public String getHeadImgerURL() {
		return headImgerURL;
	}

	public void setHeadImgerURL(String headImgerURL) {
		this.headImgerURL = headImgerURL;
	}
